...
<button
    ...
    style="display: flex; align-items: center; width: 100%; max-width: 20rem; gap: 0.75rem; padding: 0.5rem 0.75rem 0.5rem 1rem; border-radius: 0.5rem; border: 1px solid var(--gray-200, #e5e7eb); background: var(--gray-50, #f9fafb); font-size: 0.875rem; line-height: 1.25rem; color: var(--gray-500, #6b7280); text-align: left; transition: border-color 0.15s, background-color 0.15s; min-height: 2.5rem; outline: none; cursor: pointer;"
...
>
    ...
    <kbd style="flex-shrink: 0; padding: 0.125rem 0.375rem; font-size: 0.75rem; border-radius: 0.25rem; border: 1px solid var(--gray-200, #e5e7eb); background: white; color: var(--gray-500, #6b7280);" class="dark:border-white/10 dark:bg-gray-900 dark:text-gray-400">{{ $shortcutHint }}</kbd>
</button>
@endif
